...
struct CourseRow: View {
    ...
    var body: some View {
        ...
        .overlay((isDragging || isFocused) ? RoundedRectangle(cornerRadius: 14).stroke(Color(.separator).opacity(0.5), lineWidth: 0.5)
        ...
        .animation(isFocused ? .smooth(duration: 0.3) : .smooth(duration: 0.15), value: isFocused)
    }
}
